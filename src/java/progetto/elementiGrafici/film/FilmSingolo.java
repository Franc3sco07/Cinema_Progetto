package progetto.elementiGrafici.film;
...
import progetto.state.amministrazione.dipendente.PrenotazioneDipendeteState;
import progetto.state.film.FilmState;
import progetto.state.film.ProiezioneState;
    ...
    private void initComponents() {
        ...
        if (Session.getSessioneCorrente().getUtenteConesso().getTipo().equals(TipiUtente.ADMIN.tipo)) {
            ...
            bottoneModifica.addActionListener(evt -> {
                ...
                JLabel testo = new JLabel("<html>  Sei sicuro di voler eliminare il film?<br>Eliminerà tutte le prenotazioni e proiezioni</html>");
